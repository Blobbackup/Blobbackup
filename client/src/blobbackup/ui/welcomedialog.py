...
class Ui_WelcomeDialog(object):
    def setupUi(self, WelcomeDialog):
        ...
        self.terms_of_service_label.setTextFormat(QtCore.Qt.RichText)
        self.terms_of_service_label.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.restore_files_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
