    ...
    <section class="md:flex mt-4 md:mt-8">
        ...
        <div class="md:w-3/5 px-4 md:px-0">
            ...
            <p class="text-xl md:text-2xl text-gray-600 mt-4">
                ...
                You can read my full <a href="/blog/getting-started-with-blobbackup" class="text-blue-600 underline">blog post</a> for details but in short:
            </p>
            <ul class="text-xl md:text-2xl text-gray-600 list-disc ml-8 mt-4">
                ...
                <li>
                    ...
                    the public can analyze the code and more importantly, retain access to the software if the company
                    disappears.
                </li>
                <li>
            ...
            <p class="text-right text-gray-600 mt-4 border-t border-gray-300 pt-4">
                BlobBackup, LLC <br/>
                1590 S Warrior Ln <br/>
                Waukee, IA 50263
            </p>
        </div>
    </section>
