...
<html>
    <head>
        ...
        <meta name="description" content="Blobbackup is a private, open source and secure cloud computer backup service. Personal backup without compromising any privacy for ${{ $page->perComputerPrice }} per month."/>
        ...
        <header class="shadow-lg bg-white sticky top-0 z-50">
            <div class="mx-auto flex max-w-7xl p-6">
                ...
                <div class="flex-1 text-right font-bold text-lg mt-1 hidden md:block">
                    ...
                    <a href="/support" class="ml-4">Help</a>
                ...
                <div id="responsive-menu" class="hidden absolute top-0 left-0 w-full h-screen p-6 bg-white">
                    ...
                    <div class="font-bold text-xl mt-8">
                        ...
                        <a href="/support" class="block underline mt-4">Help</a>
