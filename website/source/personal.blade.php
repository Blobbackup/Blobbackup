...
<div class="mx-auto max-w-5xl p-4">
    ...
    <section class="text-center md:mt-16">
        <h1 class="text-4xl md:text-5xl font-bold mt-8 md:mt-16 text-center">${{ $page->perComputerPrice }} / Month Flat</h1>
        ...
        <section class="mt-8 max-w-2xl mx-auto md:mt-16 text-center grid gap-8">
            ...
            <div>
                ...
                <p class="text-lg text-gray-600 mt-2">
                    When you create an account with Blobbackup, you'll be given the option to invite other
                    family members into your "Group". You, as the group owner, will then be charged for all computers
                    backed up in your group.
                </p>
            </div>
            <div>
                <h1 class="text-xl md:text-2xl font-bold mt-2">
