...
from blobbackup.ui_config_s3_dialog import Ui_ConfigS3Dialog
from blobbackup.validator import Validator
from blobbackup.models import Backup, Backups
from blobbackup.command_thread import CommandThread, config_worker


class ConfigS3Dialog(QDialog, Ui_ConfigS3Dialog):
    def __init__(self, window, just_save=False):
        QDialog.__init__(self)
        Ui_ConfigS3Dialog.__init__(self)
