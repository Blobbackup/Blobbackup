...
<x-app-layout>
    ...
    <div class="shadow-lg my-8 p-6">
        <div>
            ...
            <a href="{{ asset('bin/blobbackup-darwin-amd-1.0.5.dmg') }}" class="text-blue-600 underline">Intel Mac</a> |
            <a href="{{ asset('bin/blobbackup-darwin-arm-1.0.5.dmg') }}" class="text-blue-600 underline">M1 Mac</a> |
            <a href="{{ asset('bin/blobbackup-win-1.0.5.exe') }}" class="text-blue-600 underline">Windows</a>.
        </div>
        <div class="mt-4">
